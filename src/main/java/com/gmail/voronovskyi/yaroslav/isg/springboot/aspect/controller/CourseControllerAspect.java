...
public class CourseControllerAspect {
    ...
    private static final String API_POINT_CUT =
            "execution(* com.gmail.voronovskyi.yaroslav.isg.springboot.controller.CoursesController.*(..))";
    ...
    private static final String API_POINT_CUT_PARAMETER = "courseLogController()";
    ...
    public void courseLogController() {
    }
