...
public class GroupControllerAspect {

    private static final int MIN_SIZE = 1;
    private static final String API_POINT_CUT =
            "execution(* com.gmail.voronovskyi.yaroslav.isg.springboot.controller.GroupsController.*(..))";
    ...
    private static final String API_POINT_CUT_PARAMETER = "groupLogController()";
    ...
    public void groupLogController() {
    }
